  ...
  return (
    <>
      ...
      <div className="flex flex-row justify-between items-center m-8 md:m-16">
        ...
        <div>
          <button className="bg-white text-black text-sm p-2 rounded-full px-4 mr-8 md:mr-16 hover:bg-gray-200 transition duration-300 ease-in-out" onClick={()=>window.location.href = resumeLink}>
            Download CV
          </button>
        </div>
